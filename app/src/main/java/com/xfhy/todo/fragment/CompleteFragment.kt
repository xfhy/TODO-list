 ...
 * Description : 已完成清单
 */
class CompleteFragment : BaseMvpFragment<CompleteFragmentContract.Presenter>(),
        CompleteFragmentContract.View, BaseQuickAdapter.OnItemClickListener<TodoBean.Data.TodoItem, BaseViewHolder>,
        BaseQuickAdapter.RequestLoadMoreListener,
        SwipeRefreshLayout.OnRefreshListener, TodoAdapter.OnClickListener {
    ...
    private fun initView() {
        ...
        //adapter
        mTodoAdapter = TodoAdapter(null,true)
    ...
    override fun showTips(tips: String) {
        SnackbarUtil.showBarShortTime(mRefreshLayout, tips, SnackbarUtil.INFO)
    }
    ...
    override fun onItemClick(adapter: BaseQuickAdapter<TodoBean.Data.TodoItem, BaseViewHolder>, view: View, position: Int) {
        ...
        EditTodoActivity.enterEditTodoActivity(this, adapter.getItem(position), TodoFragment.EDIT_REQUEST_CODE)
    }
    ...
    override fun doneTodoItem(position: Int) {
        ...
        todoData ?: return
        //标记网络数据
        mPresenter?.markTodoStatus(todoData[position].id, Constant.UNDONE_STATES)
